      ...
      <div className="container mt-4">
        ...
        <div className="row row-cols-md-2 mt-2">
          <div className="col mb-5">
            <h1> Quienes somos </h1>
            <p>Somos una organización ambiental que ofrece una experiencia única de contacto con la riqueza natural y cultural de Colombia, que promueve y ejecuta programas de educación, comunicación, recreación e investigación para la conservación de la biodiversidad colombiana.</p>
          </div>

          <div className="col mb-5">
            <ReactPlayer url='https://www.youtube.com/watch?v=ByvDEnOTPKI&feature=emb_logo' controls={true} />
          </div>
        </div>
        ...
        <div class="text-center">
          <div className="row row-cols-md-2 mt-2">
            <div className="col mb-5">
              <h1>Misión</h1>
              <p className="text-left">Creamos experiencias inolvidables para contagiar nuestra pasión por la vida.</p>
            </div>
            <div className="col mb-5">
              <h1>Valores</h1>
